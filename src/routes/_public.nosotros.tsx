    ...
    <div className="mx-auto max-w-7xl px-4 py-12">
      <div className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
          Hace más de 15 años cuidamos las sonrisas de las familias chilenas combinando tecnología, calidez humana y excelencia clínica.
        </p>
      </div>

      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {[
          { icon: Heart, title: "Nuestra misión", text: "Entregar atención dental de excelencia con un trato cercano y personalizado para cada paciente." },
          { icon: Award, title: "Nuestra visión", text: "Ser la clínica dental de referencia en Chile por su calidad clínica y experiencia del paciente." },
          { icon: Users, title: "Nuestros valores", text: "Confianza, compromiso, innovación y respeto guían cada decisión clínica y humana." },
        ].map((c, i) => (
      ...
      <div className="mt-16">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Especialistas con vocación y experiencia.</p>
